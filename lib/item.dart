...
Future<List<Item>> requestItem(int fId) async {
  var url = Uri.parse('http://$ip/fridges/${fId.toString()}');
...
void updateItem(
    String i_name, int iId, int fId, int cuantity, int drawer) async {
  var url = Uri.parse('http://$ip/fridges/${fId.toString()}/${iId.toString()}');
